...
/* ─── Features Data ─────────────────────────────────── */
const features = [
    { icon: FiShield, title: 'Escrow Protection', desc: 'Payments are held in a secure digital escrow until you confirm satisfaction. Zero risk for students.', color: 'bg-emerald-50 text-emerald-600 border-emerald-100' },
    { icon: FiCheckCircle, title: 'Verified Agents', desc: 'Every agent undergoes ID verification and admin approval. Only genuine listings make it to the platform.', color: 'bg-blue-50 text-blue-600 border-blue-100' },
    { icon: FiCreditCard, title: 'Digital Wallet', desc: 'Fund your wallet instantly and pay for bookings with one click. Track every naira with detailed transaction history.', color: 'bg-violet-50 text-violet-600 border-violet-100' },
    { icon: FiSearch, title: 'Smart Search', desc: 'Filter hostels by location, price range, and amenities. Find your ideal accommodation in seconds.', color: 'bg-cyan-50 text-cyan-600 border-cyan-100' },
    { icon: FiUsers, title: 'Student Community', desc: 'Read reviews from real students, share your experiences, and help others find safe housing.', color: 'bg-amber-50 text-amber-600 border-amber-100' },
    { icon: FiStar, title: 'Instant Booking', desc: 'Book your hostel without leaving your room. Manage everything from your personalized dashboard.', color: 'bg-pink-50 text-pink-600 border-pink-100' },
];
    ...
    return (
        ...
        ════════════════════════════════════════════════════════ */}
                <section className="relative -mt-8 z-20">
                    <div className="max-w-5xl mx-auto px-6">
                        <div className="bg-white rounded-3xl shadow-2xl shadow-indigo-200/50 border border-gray-100 grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
                            {stats.map((stat) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                            {steps.map((step, i) => (
                                <div key={step.num} className="relative group">
                                    <div className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-indigo-200 hover:shadow-xl transition-all duration-300 h-full">
                                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center text-white text-sm font-black mb-4 group-hover:scale-110 transition-transform`}>
                                            {step.num}
                                        </div>
        ...
        ════════════════════════════════════════════════════════ */}
                <section className="py-24 bg-white">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <span className="text-indigo-600 font-bold text-sm uppercase tracking-widest">Why Choose Us</span>
                            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mt-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {features.map((feat) => (
                                <div key={feat.title} className="group p-8 rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-xl transition-all duration-300 bg-white">
                                    <div className={`w-14 h-14 rounded-2xl ${feat.color} border flex items-center justify-center text-2xl mb-5 group-hover:scale-110 transition-transform`}>
                                        <feat.icon />
                                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative">
                                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                                    <h3 className="text-2xl font-black text-gray-900 mb-6">How Escrow Works</h3>
                                        ...
                                        {[
                                            ...
                                            <div key={item.step} className="flex items-start gap-4">
                                                <div className={`flex flex-col items-center`}>
                                                    ...
                                                    {i < 2 && <div className={`w-0.5 h-8 border-l-2 border-dashed ${item.line} mt-1`} />}
                                                </div>
                                ...
                                {/* Decorative */}
                                <div className="absolute -z-10 -bottom-6 -right-6 w-full h-full bg-indigo-100/50 rounded-3xl" />
                            </div>

                            {/* Right: Copy */}
                            <div>
                                <span className="text-indigo-600 font-bold text-sm uppercase tracking-widest">Zero Risk</span>
                                ...
                                <p className="text-gray-500 text-lg mt-4 leading-relaxed">
                                    <strong className="text-gray-900">FUTA Housing changes everything.</strong> Our escrow system holds your payment until you physically inspect the hostel and confirm it meets your expectations. If anything is wrong, you get a full refund — no questions asked.
                                </p>
                                ...
                                <div className="mt-8 grid grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={item.label} className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                                            <p className="text-2xl font-black text-indigo-600">{item.val}</p>
        ...
        ════════════════════════════════════════════════════════ */}
                <section className="py-24 bg-white">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <span className="text-indigo-600 font-bold text-sm uppercase tracking-widest">Testimonials</span>
                            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mt-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {testimonials.map((t) => (
                                <div key={t.name} className="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition-shadow">
                                    {/* Stars */}
                ...
                {/* ════════════════════════════════════════════════════════
            SECTION 7: FOR AGENTS
        ════════════════════════════════════════════════════════ */}
                <section className="py-24 bg-gradient-to-r from-violet-600 to-indigo-600 text-white">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <span className="text-violet-200 font-bold text-sm uppercase tracking-widest">For Agents</span>
                                <h2 className="text-4xl md:text-5xl font-black mt-3 leading-tight">
                                    Grow your hostel business with us
                                </h2>
                                <p className="text-violet-200 text-lg mt-6 leading-relaxed">
                                ...
                                <Link href="/auth/agent-register"
                                    className="mt-8 inline-flex items-center gap-2 bg-white text-indigo-700 font-bold px-8 py-4 rounded-2xl hover:bg-gray-100 transition-all shadow-lg text-lg">
        ...
        ════════════════════════════════════════════════════════ */}
                <section className="py-24 bg-gray-50">
                    <div className="max-w-3xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <span className="text-indigo-600 font-bold text-sm uppercase tracking-widest">FAQ</span>
                            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mt-3">
                            ...
                            {faqs.map((faq, i) => (
                                <div key={i} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                                    <button
                                        ...
                                        className="w-full text-left flex items-center justify-between p-6 hover:bg-gray-50 transition"
                                    >
        ...
        ════════════════════════════════════════════════════════ */}
                <section className="py-24 bg-white">
                    <div className="max-w-4xl mx-auto px-6 text-center">
                        <Image src="/logo.png" alt="FUTA Housing" width={64} height={64} className="mx-auto rounded-2xl mb-6" />
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                            <Link href="/auth/register"
                                className="group inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-8 py-4 rounded-2xl transition-all shadow-lg shadow-indigo-200 text-lg">
                                Get Started Free <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
                            </Link>
                            <Link href="/hostels"
                                className="inline-flex items-center justify-center gap-2 border-2 border-gray-200 text-gray-700 font-bold px-8 py-4 rounded-2xl hover:border-indigo-200 hover:text-indigo-600 transition-all text-lg">
                                Browse Hostels
                            </Link>
                        </div>
                    </div>
